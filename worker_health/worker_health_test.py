...
def test_flatten_dict(wh_instance):
  a = {'pixel2-perf-2': ['pixel2-33', 'pixel2-54', 'pixel2-37'], 'gecko-t-bitbar-gw-unit-p2': [], 'gecko-t-bitbar-gw-perf-p2': [], 'gecko-t-bitbar-gw-perf-g5': [], 'gecko-t-bitbar-gw-batt-p2': [], 'gecko-t-bitbar-gw-batt-g5': []}
